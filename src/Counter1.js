...
class Counter1 extends Component{
    ...
    incrementPlayer = () => {
        ...
        //ゲームセット
        if (next === 19　&& nextSet === 2 ){
            this.setState({ open1: true });
        }
        if (nextGame === 8 && nextGame1 === 8 && next === 19 && nextSet === 2 ){
            this.setState({ open1: true })
        }
        if (nextGame === 8 && nextGame1 === 8 && next === 15 && nextSet === 2 ){
            this.setState({ open1: true })
        }
        if (nextGame === 8 && nextGame1 === 6 && next === 4 && nextSet === 2 ){
            this.setState({ open1: true })
        }
        if (nextGame === 6 && next === 4 && nextGame1 < 4 && nextSet === 2 ) {
            this.setState({ open1: true })
        }
    ...
    incrementPlayer1 = () => {
        ...
        //ゲームセット
        if (next1 === 19　&& nextSet1 === 2 ){
            this.setState({ open1: true });
        }
        if (nextGame === 8 && nextGame1 === 8 && next1 === 19 && nextSet1 === 2 ){
            this.setState({ open1: true })
        }
        if (nextGame === 8 && nextGame1 === 8 && next1 === 15 && nextSet1 === 2 ){
            this.setState({ open1: true })
        }
        if (nextGame1 === 8 && nextGame === 6 && next1 === 4 && nextSet1 === 2 ){
            this.setState({ open1: true })
        }
        if (nextGame1 === 6 && next1 === 4 && nextGame < 4  &&  nextSet1 === 2 ) {
            this.setState({ open1: true })
        }
 ...
 render(){
        return (
            <div>
                ...
                <div className="center">{number3[0]}{number5[0]}{number3[1]} {number3[2]}{number5[1]}{number3[3]} {number3[4]}{number5[2]}{number3[5]}</div>
                </DialogContentText>
                </DialogContent>
                <DialogActions>
