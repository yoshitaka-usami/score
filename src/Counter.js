...
class Counter extends Component{
    ...
    reset = () =>{
      ...
      goTo = (index) => {
        return (event) => {
          console.log('goTo function', event.target);
 ...
 render(){
        return (
            <div>
                ...
                <div className="center">{number3[0]}-{number3[1]}</div>
                </DialogContentText>
                </DialogContent>
                <DialogActions>
                <Button  onClick={this.reset} color="primary" variant="contained" className="center">
                 Close
                </Button>
                </DialogActions>
                </Dialog>
